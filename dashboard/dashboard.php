        ...
        <div class="sidebar-wrapper">
            <nav class="mt-2">
                <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="dashboard.php?page=paket_wisata" class="nav-link">
                            <i class="nav-icon bi bi-box-seam fs-5"></i>
                            <p>Paket Wisata</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="dashboard.php?page=pemesanan" class="nav-link">
                            <i class="nav-icon bi bi-cart-check-fill fs-5"></i>
                            <p>Pemesanan</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="dashboard.php?page=pengguna" class="nav-link">
                            <i class="nav-icon bi bi-people-fill fs-5"></i>
                            <p>Pengguna</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="dashboard.php?page=review" class="nav-link">
                            <i class="nav-icon bi bi-star-fill fs-5"></i>
                            <p>Review</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="dashboard.php?page=pengaturan" class="nav-link">
