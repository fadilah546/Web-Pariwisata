...
if (isset($_POST['cari'])) {
  ...
  $data = $koneksi->query("SELECT * FROM wisata
   WHERE nama_wisata LIKE '%$keyword%' OR kategori LIKE '%$keyword%' OR deskripsi LIKE '%$keyword%' OR lokasi LIKE '%$keyword%' 
  ");
  if ($data && $data->num_rows > 0){
  ?>
  <section class="mt-10 px-6" id="content">
  <div class="flex justify-between items-center mb-4">
    <h2 class="text-xl font-semibold">Wisata</h2>
...
<?php
  ...
  <h3 class="font-semibold text-gray-800">Tidak ada data yang ditemukan</h3>
  <?php
  }
}
?>
